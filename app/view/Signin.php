<div class="loginform">
    <form class="form" method="post" action="index.php?page=signin">
            ...
            <div class="col">
                ...
                <div class="inputForm">
                    <input type="text" id="name" name="name"
                           class="input" placeholder="Enter your Name" value="<?php echo htmlspecialchars($name)?>">
                </div>
            </div>
            ...
            <div class="col">
                ...
                <div class="inputForm">
                    <input type="text" id="surname" name="surname"
                           class="input" placeholder="Enter your Surname" value="<?php echo htmlspecialchars($surname)?>">
                </div>
            </div>
        </div>
        ...
        <div class="inputForm">
            ...
            <input type="password" id="password_confirmation" name="pwdConf"
        ...
        <p class="p">Already have an account?
            <input style="border: none; color: blue; background-color: transparent; cursor: pointer;" type="button" id="signin" value="Log in"  onclick="window.location.href='index.php?page=login'">
        </p>
